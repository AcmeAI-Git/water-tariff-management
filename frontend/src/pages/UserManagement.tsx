...
export function UserManagement() {
  const admins = [
    { name: 'Sarah Ahmed', email: 'sarah.ahmed@watertariff.gov', role: 'Super Admin' },
    { name: 'Kamal Hassan', email: 'kamal.hassan@watertariff.gov', role: 'Tariff Admin' },
    { name: 'Nadia Chowdhury', email: 'nadia.c@watertariff.gov', role: 'Customer Admin' },
    { name: 'Rahim Uddin', email: 'rahim.uddin@watertariff.gov', role: 'Meter Admin' },
    { name: 'Ayesha Khan', email: 'ayesha.khan@watertariff.gov', role: 'Customer Admin' },
    { name: 'Ibrahim Ali', email: 'ibrahim.ali@watertariff.gov', role: 'Meter Admin' },
  ];
